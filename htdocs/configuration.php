...
class JConfig {
	...
	public $sitename = 'daas\'s Site!';				// Name of Joomla site
	...
	public $password = 'e43fa209a5';						// DB password
	public $db = 'bitnami_joomla';							// DB database name
	public $dbprefix = 'jos_';					// Do not change unless you need to!

	/* Server Settings */
	public $secret = 'a0817ddc04e0fab2ef8a6daaacc50e51'; 		// Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '';
	public $tmp_path = 'C:/Bitnami/joomla-3.3.6-0/apps/joomla/tmp';
	public $log_path = 'C:/Bitnami/joomla-3.3.6-0/apps/joomla/logs';
